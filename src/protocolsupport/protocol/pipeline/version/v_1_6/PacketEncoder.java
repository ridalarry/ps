...
import protocolsupport.protocol.packet.middleimpl.clientbound.play.v_6.Position;
...
public class PacketEncoder extends AbstractLegacyPacketEncoder {
	...
	static {
		...
		packetIdRegistry.register(NetworkState.PLAY, ClientBoundPacket.PLAY_ENTITY_ATTRIBUTES_ID, 0x2C);
		...
		packetIdRegistry.register(NetworkState.PLAY, ClientBoundPacket.PLAY_SIGN_EDITOR_ID, 0x85);
